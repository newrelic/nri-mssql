...
//			COALESCE(
//				n.value('(@EstimatedOperatorCost)[1]', 'FLOAT'),
//				0.0
//			) AS EstimatedOperatorCost,
//			COALESCE(
//				n.value('(@EstimatedExecutionMode)[1]', 'VARCHAR(50)'),
//				'N/A'
...
//	executionPlans := make([]QueryExecutionPlan, 0)
//
