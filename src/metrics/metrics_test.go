...
func Test_populateDatabaseMetrics(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			connection.CreateDatabaseConnection = getNewDatabaseConnection()
...
func getNewDatabaseConnection() func(args *args.ArgumentList, dbName string) (*connection.SQLConnection, error) {
	return func(args *args.ArgumentList, dbName string) (*connection.SQLConnection, error) {
